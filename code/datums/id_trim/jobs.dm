...
/datum/id_trim/job/bartender
	...
	minimal_access = list(ACCESS_BAR, ACCESS_MAINT_TUNNELS, ACCESS_MINERAL_STOREROOM, ACCESS_THEATRE, ACCESS_WEAPONS, ACCESS_SERVICE)
...
/datum/id_trim/job/botanist
	...
	minimal_access = list(ACCESS_HYDROPONICS, ACCESS_MAINT_TUNNELS, ACCESS_MINERAL_STOREROOM, ACCESS_MORGUE, ACCESS_SERVICE)
	config_job = "botanist"
	template_access = list(ACCESS_CAPTAIN, ACCESS_HOP, ACCESS_CHANGE_IDS)
...
/datum/id_trim/job/chaplain
	...
	extra_access = list()
	minimal_access = list(ACCESS_CHAPEL_OFFICE, ACCESS_CREMATORIUM, ACCESS_MAINT_TUNNELS, ACCESS_MORGUE, ACCESS_THEATRE, ACCESS_SERVICE)
	config_job = "chaplain"
	template_access = list(ACCESS_CAPTAIN, ACCESS_HOP, ACCESS_CHANGE_IDS)
...
/datum/id_trim/job/clown
	...
	extra_access = list()
	minimal_access = list(ACCESS_MAINT_TUNNELS, ACCESS_THEATRE, ACCESS_SERVICE)
	config_job = "clown"
	template_access = list(ACCESS_CAPTAIN, ACCESS_HOP, ACCESS_CHANGE_IDS)
	job = /datum/job/clown
...
/datum/id_trim/job/cook
	...
	minimal_access = list(ACCESS_KITCHEN, ACCESS_MAINT_TUNNELS, ACCESS_MINERAL_STOREROOM, ACCESS_MORGUE, ACCESS_SERVICE)
	config_job = "cook"
	template_access = list(ACCESS_CAPTAIN, ACCESS_HOP, ACCESS_CHANGE_IDS)
	job = /datum/job/cook
...
/datum/id_trim/job/curator
	...
	extra_access = list()
	minimal_access = list(ACCESS_AUX_BASE, ACCESS_LIBRARY, ACCESS_MAINT_TUNNELS, ACCESS_MINING_STATION, ACCESS_SERVICE)
	config_job = "curator"
	template_access = list(ACCESS_CAPTAIN, ACCESS_HOP, ACCESS_CHANGE_IDS)
...
/datum/id_trim/job/lawyer
	...
	extra_access = list()
	minimal_access = list(ACCESS_COURT, ACCESS_LAWYER, ACCESS_MAINT_TUNNELS, ACCESS_BRIG_ENTRANCE, ACCESS_SERVICE)
	config_job = "lawyer"
...
/datum/id_trim/job/psychologist
	...
	extra_access = list()
	minimal_access = list(ACCESS_MAINT_TUNNELS, ACCESS_MEDICAL, ACCESS_PSYCHOLOGY, ACCESS_SERVICE)
