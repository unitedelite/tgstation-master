...
#define COMSIG_KB_CLIENT_LOOC_DOWN "keybinding_client_looc_down" // from Skyrat code/__DEFINES/~skyrat_defines/keybindings.dm
#define COMSIG_KB_CLIENT_WHISPER_DOWN "keybinding_client_whisper_down" // from Skyrat code/__DEFINES/~skyrat_defines/keybindings.dm
