...
GLOBAL_LIST_INIT(meteors_normal, list(/obj/effect/meteor/dust=5, /obj/effect/meteor/medium=8, /obj/effect/meteor/big=2, \
						  /obj/effect/meteor/flaming=1, /obj/effect/meteor/irradiated=3)) //for normal meteor event

GLOBAL_LIST_INIT(meteors_threatening, list(/obj/effect/meteor/dust=4, /obj/effect/meteor/medium=7, /obj/effect/meteor/big=7, \
						  /obj/effect/meteor/flaming=3, /obj/effect/meteor/irradiated=3)) //for threatening meteor event

GLOBAL_LIST_INIT(meteors_catastrophic, list(/obj/effect/meteor/medium=5, /obj/effect/meteor/big=8, \
						  /obj/effect/meteor/flaming=4, /obj/effect/meteor/irradiated=2)) //for catastrophic meteor event
