//From Skyrat-tg/modular_skyrat/modules/verbs/code/looc.dm 

/proc/looc_get_top_level_mob(var/mob/S)
	if(istype(S.loc,/mob)&&S.loc!=S)
		var/mob/M=S.loc
		return looc_get_top_level_mob(M)
	return S
/client/verb/looc(msg as text)
	...
	var/list/heard = get_hearers_in_view(7, looc_get_top_level_mob(src.mob))
